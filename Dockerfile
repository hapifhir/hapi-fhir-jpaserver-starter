...
# Copy local 4.12.0-package-tx-resource-expand-738e721c7-SNAPSHOT dependencies from the host .m2 repository BEFORE
...
COPY --from=local-m2 cqf-fhir-cql/4.12.0-package-tx-resource-expand-738e721c7-SNAPSHOT /root/.m2/repository/org/opencds/cqf/fhir/cqf-fhir-cql/4.12.0-package-tx-resource-expand-738e721c7-SNAPSHOT/
COPY --from=local-m2 cqf-fhir-cr/4.12.0-package-tx-resource-expand-738e721c7-SNAPSHOT /root/.m2/repository/org/opencds/cqf/fhir/cqf-fhir-cr/4.12.0-package-tx-resource-expand-738e721c7-SNAPSHOT/
COPY --from=local-m2 cqf-fhir-cr-hapi/4.12.0-package-tx-resource-expand-738e721c7-SNAPSHOT /root/.m2/repository/org/opencds/cqf/fhir/cqf-fhir-cr-hapi/4.12.0-package-tx-resource-expand-738e721c7-SNAPSHOT/
COPY --from=local-m2 cqf-fhir-utility/4.12.0-package-tx-resource-expand-738e721c7-SNAPSHOT /root/.m2/repository/org/opencds/cqf/fhir/cqf-fhir-utility/4.12.0-package-tx-resource-expand-738e721c7-SNAPSHOT/
