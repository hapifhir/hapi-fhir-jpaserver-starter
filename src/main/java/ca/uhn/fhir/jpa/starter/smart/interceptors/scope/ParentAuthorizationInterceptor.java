...
public class ParentAuthorizationInterceptor extends AuthorizationInterceptor {
	...
	private final List<ResourceScopedAuthorizationInterceptor> resourceInterceptors;
	private static final String RULE_DENY_ALL_UNKNOWN_REQUESTS = "Deny all requests that do not match any pre-defined rules";

	public ParentAuthorizationInterceptor(@Autowired List<ResourceScopedAuthorizationInterceptor> resourceInterceptors) {
	...
	public List<IAuthRule> buildRuleList(RequestDetails theRequestDetails) {
		...
		for (ResourceScopedAuthorizationInterceptor resourceInterceptor:resourceInterceptors) {
