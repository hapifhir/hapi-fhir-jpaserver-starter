 ...
 */
public class ExtInMemoryTerminologyServerValidationSupport extends InMemoryTerminologyServerValidationSupport {
	private final FhirContext myCtx;

	private static final Logger ourLog = LoggerFactory.getLogger(ExtInMemoryTerminologyServerValidationSupport.class);

	public ExtInMemoryTerminologyServerValidationSupport(FhirContext theCtx) {
		super(theCtx);
		myCtx = theCtx;
	}
