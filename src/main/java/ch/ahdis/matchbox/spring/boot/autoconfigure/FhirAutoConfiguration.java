...
public class FhirAutoConfiguration {
  ...
  public FhirProperties getProperties() {
	...
	static class FhirRestfulServerConfiguration extends RestfulServer {
		...
		@Override
    protected ServletRequestDetails newRequestDetails(RequestTypeEnum theRequestType, HttpServletRequest theRequest,
        HttpServletResponse theResponse) {
      return super.newRequestDetails(theRequestType, theRequest, theResponse);
    }
