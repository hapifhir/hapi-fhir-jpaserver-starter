...
// // Override is currently required when using MDM as the construction of the
// MDM
// // beans are ambiguous as they are constructed multiple places. This is
// evident
// // when running in a spring boot environment
// "spring.main.allow-bean-definition-overriding=true" })
// class ExampleServerR4IT implements IServerSupport{
// private static final org.slf4j.Logger ourLog =
// org.slf4j.LoggerFactory.getLogger(ExampleServerR4IT.class);
...
// String measureUrl =
// "http://ecqi.healthit.gov/ecqms/Measure/ColorectalCancerScreeningsFHIR";
...
// inParams.addParameter().setName("reportType").setValue(new
// StringType("summary"));
...
// List<Parameters.ParametersParameterComponent> response =
// outParams.getParameter();
...
// private org.hl7.fhir.r4.model.Bundle loadBundle(String theLocation,
// FhirContext theCtx, IGenericClient theClient) throws IOException {
// String json = stringFromResource(theLocation);
// org.hl7.fhir.r4.model.Bundle bundle = (org.hl7.fhir.r4.model.Bundle)
// theCtx.newJsonParser().parseResource(json);
// org.hl7.fhir.r4.model.Bundle result =
// theClient.transaction().withBundle(bundle).execute();
// return result;
// }
...
// Parameters params = parameters(stringPart("expression", "Interval[Today() - 2
// years, Today())"));
// Parameters results = runCqlExecution(params);
// assertTrue(results.getParameter("return").getValue() instanceof Period);
// }

// private IBaseResource loadRec(String theLocation, FhirContext theCtx,
// IGenericClient theClient) throws IOException {
// String json = stringFromResource(theLocation);
...
// "}";
// Bundle bundle =
// FhirContext.forR4().newJsonParser().parseResource(Bundle.class, batchPuts);
...
// await().atMost(1, TimeUnit.MINUTES).until(() -> activeSubscriptionCount() ==
// 3);
...
// SocketImplementation(mySubscriptionId.getIdPart(),
// EncodingEnum.JSON);
...
// loadBundle("r4/CareGaps/BreastCancerScreeningFHIR-bundle.json", ourCtx,
// ourClient);

// Parameters params = new Parameters();
// params.addParameter().setName("periodStart").setValue(new
// DateType(periodStartValid));
// params.addParameter().setName("periodEnd").setValue(new
// DateType(periodEndValid));
// params.addParameter().setName("subject").setValue(new
// StringType(subjectPatientValid));
// params.addParameter().setName("status").setValue(new
// StringType(statusValid));
// params.addParameter().setName("measureId").setValue(new
// IdType(measureIdValid));
...
// .cacheControl(new
// CacheControlDirective().setNoCache(true)).returnBundle(Bundle.class).execute().getEntry()
// .size();
// }
...
// // return activeSubscriptionCount() == 2; // 2 subscription based on
// mdm-rules.json
// //});
// }
// }
