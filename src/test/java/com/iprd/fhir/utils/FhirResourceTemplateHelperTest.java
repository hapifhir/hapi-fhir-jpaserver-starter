...
public class FhirResourceTemplateHelperTest {
	...
	public void testClinic() {
		Organization test = FhirResourceTemplateHelper.clinic("St Lucia Hospital", "19145158", "30/08/1/1/1/0019",
				"+234", "78945645796", "oyo", "Ibadan South West","Primary" ,"Agbokojo", "sds", "58562");
		...
		assertEquals(test.getIdentifier().get(2).getId(), "Primary");
	...
	public void testPractitioner() throws Exception {
		Practitioner test = FhirResourceTemplateHelper.hcw("temp", "nurse", "+91", "8150038173", "female", "09/22/1995",
				"Oyo", "Ibadan-South-West", "Agbokojo", "19145158", "Nurse", "Bachelor-of-Nursing", "N123", "52620");
	...
	public void testPractitionerRole() {
		PractitionerRole test = FhirResourceTemplateHelper.practitionerRole("Nurse", "Bachelor-of-Nursing",
				"32621379-fe59-49a0-93e9-203226d0cf52", "32621379-fe59-49a0-93e9-203226d0cf52");
