...
public class MatchboxEngineCreationException extends RuntimeException {
	 ...
	 *                method.
	 */
	public MatchboxEngineCreationException(final String message) {
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public MatchboxEngineCreationException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public MatchboxEngineCreationException(final Throwable cause) {
		super(cause);
	}
}
