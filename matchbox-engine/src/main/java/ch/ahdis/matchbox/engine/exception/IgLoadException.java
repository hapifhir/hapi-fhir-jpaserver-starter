...
public class IgLoadException extends MatchboxEngineCreationException {
	 ...
	 *                method.
	 */
	public IgLoadException(final String message) {
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public IgLoadException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public IgLoadException(final Throwable cause) {
		super(cause);
	}
}
