...
| txServer              | 0..1  | txServer to use, n/a if none (default), http://localhost:8080/fhir for internal (if server.port in application.yaml is 8080), http://tx.fhir.org for hl7 validator, if the terminology server is protected by an API key see configuration notes below                                                                                                                                                                                                                                                                                             |
