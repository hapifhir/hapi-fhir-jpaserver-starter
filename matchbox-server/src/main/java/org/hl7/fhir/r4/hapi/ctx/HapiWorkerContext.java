...
public final class HapiWorkerContext extends I18nBase implements IWorkerContext {
	...
	public ValidationResult validateCode(
			ValidationOptions theOptions, String theSystem, String theCode, String theDisplay) {
	...
	@Override
	public ValueSetExpander.ValueSetExpansionOutcome expandVS(ConceptSetComponent theInc, boolean theHierarchical)
	...
	// matchbox PATCH: the following methods are copied from the R5 class
	@Override
