...
*/
  ...
  // modified by matchbox, we wan't to run a job after startup
/*
...
// nFIXME		repositoryValidatingInterceptor.ifPresent(fhirServer::registerInterceptor);
