...
public class ValidationResultWithExtensions extends ca.uhn.fhir.validation.ValidationResult {
...
//  }
  ...
  public void addLocationLineToIssue(FhirContext theContext, IBase theIssue, int theLocation) {
    ...
    IBaseExtension<?,?> extensionElem = (IBaseExtension<?,?>) extensionChild.getChildByName("extension").newInstance(extensionChild.getInstanceConstructorArguments());
