...
public class MatchboxApiR5onR4Test {
  ...
  public void verifyCachingImplementationGuides() {
    ...
    String profileCore = "http://hl7.org/fhir/StructureDefinition/Practitioner|5.0.0";
    ...
    assertEquals("http://localhost:8085/matchboxv3/tx", this.getTxServer(this.context, operationOutcome));
